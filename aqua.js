  ...
  var url = web["web"]; 
   ...
   $.ajax({
    ...
    .then((querySnapshot) => {
     ...
     document.getElementById("emaillink").innerHTML = "<a href='mailto:" + doc.data().email + "?subject=Upcoming Meeting at Aqua-Aerobic Systems on " + dates + "&body=" + doc.data().firstname + " " + doc.data().lastname + ",%0D%0A%0D%0AMeeting Date/Time: " + dates + "%0D%0A%0D%0APurpose of Meeting : " + doc.data().message + "%0D%0A%0D%0AA unique QR code can be used to Check-in at the iPad stand in our lobby.%0D%0A%0D%0APlease use the below link to get your QR code.%0D%0A" + document.getElementById("bitly").value + "%0D%0A%0D%0ALearn how to use our check-in/check-out system: "  + "<a href='https://youtu.be/6hxZn-wAfwY'>Watch Now</a>"'>Click here to create email to guest...</a>";
