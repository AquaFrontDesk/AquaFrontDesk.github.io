  ...
  var url = web["web"]; 
   ...
   $.ajax({
    ...
    alert("All fields required!")
	  ...
	  var get_iPad = data["iPad"];
	   var website = get_id  + '&checkin=Now';	
           ...
           var cwebsite = "https://aquafrontdesk.github.io/?key=" + website;
         console.log(get_id);
    ...
    .then((querySnapshot) => {
     ...
     document.getElementById("emaillink").innerHTML = "<a href='mailto:" + doc.data().email + "?subject=Upcoming Meeting at Aqua-Aerobic Systems on " + dates + "&body=" + doc.data().firstname + " " + doc.data().lastname + ",%0D%0A%0D%0AMeeting Date/Time: " + dates + "%0D%0A%0D%0APurpose of Meeting : " + doc.data().message + "%0D%0A%0D%0AA unique QR code can be used to Check-in at the iPad stand in our lobby.%0D%0A%0D%0APlease use the below link to get your QR code.%0D%0A" + document.getElementById("bitly").value + "'>Click here to create email to guest...</a>";
  ...
  value: varwebsite
   ...
   // document.write("<br><br>While waiting, please put on generated badge from printer!");
    ...
    console.log("checkin successful");
	  ...
	  document.write('<img id="logo" src="aqua.jpg" width="250px"><br>');
	    document.write("<p style='font-size:20px;'>Thank you, " + varFName + " " + varLName + "</p>");
          document.write("<p style='font-size:16px;color: black;'>You have been successfully checked out!</p>");
           document.write("<p style='font-size:14px;color: black;'>Please dispose of your badge before leaving reception/lobby!</p>");
            document.write("<p style='font-size:14px;color: blue;'>Have a great day!</p>");
	  document.write("<p style='font-size:10px;color: black;'><br><br><br>current date/time: " + NowTime + "</p>");
	   document.write("</center>");
    document.write('</body>');
    console.log("checkout successful");
	    ...
	    document.write('<body style="font-family: sans-serif;color: blue;">');
             document.write("<br><br><br><br><br><center>");
	  document.write('<img id="logo" src="aqua.jpg" width="250px"><br>');
	    document.write("<p style='font-size:20px;'>Hello, " + varFName + " " + varLName + "</p>");
         document.write("<p style='font-size:16px;color: black;'>This QR code has expired!</p>");
	   document.write("<p style='font-size:14px;color: black;'>Please dispose of your badge before leaving reception/lobby!</p>");
            document.write("<p style='font-size:14px;color: blue;'>Have a great day!</p>");
	   document.write("<p style='font-size:10px;color: black;'><br><br><br>current date/time: " + NowTime + "</p></center>");
	   document.write("</center>");
         document.write('</body>');
  }else{
   ...
   return datum/1000;
    ...
    .catch((error) => {
     ...
     var title = "<center><h1>Aqua-Aerobic Systems Check-in/out Visitor Schedule</h1><h2>Active Visitor Schedule(s) for: " + get_login + "</h2><a href='https://aquafrontdesk.github.io/'>Go Home</a><br><br></center>";
    ...
    var lines = "";
            let today = new Date().toISOString().slice(0, 10);
	   var title = "<center><h1>Aqua-Aerobic Systems Check-in/out Visitor Schedule</h1><h2>Active Visitor Schedule(s) </h2><a href='https://aquafrontdesk.github.io/'>Go Home</a><br><br></center>";
    ...
    .catch((error) => {
	 ...
	 var start = new Date();
         ...
         var header = "<head><style>table, td, th {  border: 1px solid #cbbbbb;  text-align: left;}table {  border-collapse: collapse;  width: 100%;}th, td {  padding: 15px;} tr:nth-child(even) {  background-color: #dddddd;}</style></head>";
	 var title = "<center><h2>Active Visitor Schedule(s) for: " + todays + "</h2><a href='https://aquafrontdesk.github.io/'></a><br><br></center>";      
    ...
    .catch((error) => {
     ...
     console.log(get_login);
      var header = "<head><style>table, td, th {  border: 1px solid #cbbbbb;  text-align: left;}table {  border-collapse: collapse;  width: 100%;}th, td {  padding: 15px;} tr:nth-child(even) {  background-color: #dddddd;}</style></head>";
    var title = "<center><h1>Aqua-Aerobic Systems Check-in/out Visitor Schedule</h1><h2>In-Active Visitor Schedule(s) for: " + get_login + "</h2><a href='https://aquafrontdesk.github.io/'>Go Home</a></center>";      
